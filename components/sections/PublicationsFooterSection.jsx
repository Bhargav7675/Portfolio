...
export default function PublicationsFooterSection() {
  ...
  useEffect(() => {
    ...
    let renderer, vidUni, vidTex, vidMat, vidGeo, rafId, videoPlaying = false
    ...
    if (!isMobile && canvas && videoEl) {
      ...
      vidGeo = new THREE.PlaneGeometry(W * 1.08, H * 1.08)
  ...
  return (
    <div id="credentials" ref={wrapperRef} className={styles.wrapper}>
      <div ref={stickyRef} className={styles.sticky}>
        ...
        <div ref={pubContentRef} className={styles.pubContent}>
          <span className={styles.watermark} aria-hidden>CREDENTIALS</span>

          <div className={styles.pubHero}>
            <p ref={labelRef} className={styles.label}>Learning &amp; Validation</p>
            ...
            <div ref={leftRef} className={styles.leftCol}>
              ...
              <div className={styles.footerInfo}>
                ...
                <div className={styles.footerLinks}>
                  {profile.socials.filter(s => s.label !== 'VK').slice(0, 4).map((s, i) => (
          ...
          <div ref={bottomBarRef} className={styles.bottomBar}>
            <div className={styles.bottomLeft}>
              <div className={styles.monogram}>
                <span className={styles.monoLetters}>BB</span>
