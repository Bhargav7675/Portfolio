...
export const metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicons/bhargav-boyapati.svg', type: 'image/svg+xml' },
      { url: '/favicons/bhargav-boyapati-16.png', sizes: '16x16', type: 'image/png' },
      { url: '/favicons/bhargav-boyapati-32.png', sizes: '32x32', type: 'image/png' },
      { url: '/favicons/bhargav-boyapati-48.png', sizes: '48x48', type: 'image/png' },
    ],
    apple: [
      { url: '/favicons/bhargav-boyapati-180.png', sizes: '180x180', type: 'image/png' },
    ],
    other: [
      { rel: 'icon', url: '/favicons/bhargav-boyapati-192.png', sizes: '192x192', type: 'image/png' },
      { rel: 'icon', url: '/favicons/bhargav-boyapati-512.png', sizes: '512x512', type: 'image/png' },
    ],
  },
