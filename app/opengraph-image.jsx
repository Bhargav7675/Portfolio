...
const ACCENT = '#f7931e'
const photoUrl = `${SITE_URL}${profile.images.portrait}`
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            {profile.hero.pills.slice(0, 4).map((tag) => (
              <div
                key={tag}
                style={{
                  padding: '10px 18px',
          ...
          >
            {[...profile.stats.slice(0, 2), profile.hero.specialistStat].map(({ value, label }) => (
              <div
                key={label}
                style={{
                  display: 'flex',
